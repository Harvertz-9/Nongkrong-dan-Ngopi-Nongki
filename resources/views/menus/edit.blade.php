...
<body class="font-Poppins bg-stone-50 min-h-screen">
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl sm:text-3xl font-bold text-stone-800">Edit Menu</h1>
            <p class="text-stone-500 text-sm mt-1">Perbarui data menu <span class="font-semibold text-stone-700">{{ $menu->nama }}</span></p>
        </div>
            ...
            <form action="/menus/{{ $menu->id }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="harga" name="harga" value="{{ old('harga', $menu->harga) }}" required min="0"
                            placeholder="0"
                ...
                <div class="mb-5">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3" required
                        ...
                        class="w-full px-4 py-2.5 border border-stone-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition text-sm resize-none @error('deskripsi') border-red-400 @enderror">{{ old('deskripsi', $menu->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-sm text-stone-600" id="tersediaLabel">
                            {{ old('tersedia', $menu->tersedia) ? 'Tersedia' : 'Tidak Tersedia' }}
                        </span>
                    </div>
                    @error('tersedia')
                        <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
